/** File Toolkit.java - a class with general tools, version 06, 2015-07-21
   ...
   repeat         Repeat as string n times
  ...
  */
   ...
   */    
   ...
   public static String padString(String str, 
      ...
      // If we're padding on both sides of the string, cut the number of
      // characters to pad in half to allow for each of the two pad 
      // strings to fill the field to 'width'
      if (padLeft.length() > 0 && padRight.length() > 0) {
         charsToPad /= 2;
      }
  ...
  /** repeat
      repeat a string a certain number of times  
       ...
       Input
         @param   stringToRepeat   The string to repeat, 0 , 1 or more chars
         @param   nTimes           The number of times to repeat the string
         
       Process    1. Append the string to repeat to a variable that starts
                     out as the empty string
         
       Output
         @return  The string repeated nTimes
         
       Note       If nTimes is <= 0 or stringToRepeat is null, the method
                  returns the empty string
  */
   public static String repeat(String stringToRepeat, int nTimes) {
      String result = "";
